...
Unlike [Tutorial 1](#/USB244/07-tutorial-1-information-memorandum), this
...
> edge cases in the [Formula Sheet](#/USB244/12-formula-sheet), where a
...
> from [Part B's anchor scenario](#/USB244/14-assessment-1-part-b-sam-plan).
...
[Formula Sheet](#/USB244/12-formula-sheet)) were written for the **EOI
...
exactly the fallback the [Part A guide](#/USB244/13-assessment-1-part-a-guide
...
> table](#/USB244/12-formula-sheet) for the general rule this is an instance
